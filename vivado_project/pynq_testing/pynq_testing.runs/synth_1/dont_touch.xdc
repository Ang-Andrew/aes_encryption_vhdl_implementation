...
# XDC: new/pynq_aes_encryption_constraints.xdc

# Block Designs: bd/design_1/design_1.bd
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==design_1 || ORIG_REF_NAME==design_1} -quiet] -quiet

# IP: bd/design_1/ip/design_1_aes_encryption_wrapp_0_0/design_1_aes_encryption_wrapp_0_0.xci
set_property DONT_TOUCH TRUE [get_cells -hier -filter {REF_NAME==design_1_aes_encryption_wrapp_0_0 || ORIG_REF_NAME==design_1_aes_encryption_wrapp_0_0} -quiet] -quiet
