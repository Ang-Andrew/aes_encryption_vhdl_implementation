...
package aes_encryption_lib is
  ...
  type Word is array (0 to 3) of std_logic_vector(7 downto 0);  -- a word represents a column in the state matrix
  ...
  constant Rcon : Byte_array := (x"01", x"02", x"04", x"08", x"10",
