...
read_vhdl -vhdl2008 -library xil_defaultlib {
  ...
  D:/git_repos/aes_encryption_vhdl_implementation/vivado_project/aes_encryption_implementation/aes_encryption_implementation.srcs/sources_1/new/bitwise_xor_state.vhd
  ...
  D:/git_repos/aes_encryption_vhdl_implementation/vivado_project/aes_encryption_implementation/aes_encryption_implementation.srcs/sources_1/new/aes_encryption_wrapper.vhd
}
...
synth_design -top aes_encryption_wrapper -part xc7z020clg400-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef aes_encryption_wrapper.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file aes_encryption_wrapper_utilization_synth.rpt -pb aes_encryption_wrapper_utilization_synth.pb"
