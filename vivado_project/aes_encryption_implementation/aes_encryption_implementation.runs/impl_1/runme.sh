...
HD_PWD='D:/git_repos/aes_encryption_vhdl_implementation/vivado_project/aes_encryption_implementation/aes_encryption_implementation.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log aes_encryption_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source aes_encryption_wrapper.tcl -notrace
